...
class BantenprovSectorEgovernmentSeeder extends Seeder
{
    ...
    protected $fileName = "BantenprovSectorEgovernmentSeeder.csv";
    ...
    public function __construct(){
        ...
        $this->model = new Bantenprov\SectorEgovernment\Models\Bantenprov\SectorEgovernment\SectorEgovernment;
