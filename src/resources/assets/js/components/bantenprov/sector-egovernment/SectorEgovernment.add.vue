...
export default {
    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/sector-egovernment/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/sector-egovernment/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/sector-egovernment/create'
                  }
                },
                window.location.href = '#/admin/sector-egovernment/create')
    ...
    mounted: function() {
        axios.get("/sector-egovernment/create").then(response => {
